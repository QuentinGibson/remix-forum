        ...
        <div className="tt-topic-list">
          ...
          <div className="tt-item">
            ...
            <div className="tt-col-description">
              ...
              <div className="tt-col-message">
                ...
                Magnum P.I., Ron Swanson or Hercule Poroit! It’s the time that all
                guys (or gals) love and all our partners hate It’s Movember!
              </div>
          ...
          <div className="tt-item">
            ...
            <div className="tt-col-description">
              ...
              <div className="tt-col-message">
                <a href="#">Dylan replied:</a> I am noticed it will take little more
                time to review new authors submissions. All the Best
              </div>
              <div className="row align-items-center no-gutters hide-desktope">
                <div className="col-9">
                  <ul className="tt-list-badge">
        ...
        <div className="tt-topic-list">
          ...
          <div className="tt-item">
            ...
            <div className="tt-col-description">
              ...
              <div className="tt-content">
                I really liked new badge - T-shirt. Will there be new contests with
                new badges for AudioJungle?
              </div>
            </div>
            <div className="tt-col-category">
              <a href="#">
          ...
          <div className="tt-item">
            ...
            <div className="tt-col-description">
              ...
              <div className="tt-content">
                Can it be in not vector format but in very big resolution (far far
                beyond enough for print on shirts) ?
              </div>
            </div>
            <div className="tt-col-category">
              <a href="#">
          ...
          <div className="tt-item">
            ...
            <div className="tt-col-description">
              ...
              <div className="tt-content">
                One more question -&gt; what is the maximum space (in cm or inches)
                the design can be?
              </div>
            </div>
            <div className="tt-col-category">
          ...
          <div className="tt-item">
            ...
            <div className="tt-col-description">
              ...
              <div className="tt-content">
                Wow great to see another good contest, I hope we will submit one of
                our entry this time and try to win it
              </div>
            </div>
            <div className="tt-col-category">
              <a href="#">
          ...
          <div className="tt-item">
            ...
            <div className="tt-col-description">
              ...
              <div className="tt-content">
                Keep an eye on author dashboard or forums and thr are chances for
                such contest in each and every category on Envato market
              </div>
            </div>
            <div className="tt-col-category">
              <a href="#">
