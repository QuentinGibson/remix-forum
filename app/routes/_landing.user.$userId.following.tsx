    ...
    <div class="container">
        <div class="tt-tab-wrapper">
            <div class="tt-wrapper-inner">
                <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                    ...
                    <li class="nav-item tt-hide-xs show">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-04" role="tab" aria-selected="false"><span>526 Followers</span></a>
                    </li>
                    <li class="nav-item tt-hide-md">
                        <a class="nav-link active" data-toggle="tab" href="#tt-tab-05" role="tab" aria-selected="true"><span>489 Following</span></a>
                    </li>
                    <li class="nav-item tt-hide-md">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane tt-indent-none show" id="tt-tab-04" role="tabpanel">
                ...
                <div class="tab-pane tt-indent-none active" id="tt-tab-05" role="tabpanel">
                    <div class="tt-followers-list">
                        <div class="tt-list-header">
                            <div class="tt-col-name">User</div>
                            <div class="tt-col-value-large hide-mobile">Follow date</div>
