export default function GuideLineRoute() {
  return (
    <div className="tab-pane show fade active" id="tt-tab-02" role="tabpanel">
      <div className="tt-wrapper-inner tt-layout-tab">
        <h6 className="tt-title tt-size-lg">
          Community Rules
        </h6>
        ...
        <h6 className="tt-title">We follow a few hard rules. Please DON’T:</h6>
        <ul className="tt-list-dot tt-indent-top01">
