    ...
    <div className="tt-tab-wrapper">
      <div className="tt-wrapper-inner">
        <ul className="nav nav-tabs pt-tabs-default" role="tablist">
          ...
          <li className="nav-item tt-hide-md show">
            <a
      ...
      <div className="tab-content">
        <div className="tab-pane tt-indent-none" id="tt-tab-01" role="tabpanel">
        ...
        <div className="tab-pane show active" id="tt-tab-06" role="tabpanel">
          <div className="tt-wrapper-inner">
